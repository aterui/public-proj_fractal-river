...
The term "scale invariance" refers to the preservation of geometric (or mathematical) properties across different observation scales. This intriguing characteristic entails the existence of a consistent scaling law that facilitates the generalization of ecological patterns across a broad range of scales [@levinProblemPatternScale1992; @rodriguez-iturbeFractalRiverBasins2001; @clarkGeneralStatisticalScaling2021]. Ecologists have been captivated by the concept of scale invariance or "fractals" [@hubbellUnifiedNeutralTheory2001; @brownFractalNatureNature2002; @brownMetabolicTheoryEcology2004; @teruiMetapopulationStabilityBranching2018; @teruiEmergentDualScaling2021], and fractal theory has played a pivotal role in comprehending the dynamics of ecological systems [@brownFractalNatureNature2002].
