...
Rivers form complex branching networks with fractal characteristics. There have been concerted efforts to investigate the role of river fractals in controlling riverine ecological dynamics. The proper quantification of river network complexity is therefore critical, and some researchers used a metric of "branching probability," i.e., the probability of observing a joining tributary per unit river distance. This measure reflects the fractal nature of river networks because it exhibits the sign of scale invariance. However, a recent article by Carraro and Altermatt @carraroOptimalChannelNetworks2022 countered this classical observation and concluded that branching probability is "scale dependent." Here, I show that the original conclusion in Carraro and Altermatt @carraroOptimalChannelNetworks2022 is simply a misconception of the term "scale invariance," which is common in the ecological literature. Indeed, their data and analysis proved that branching probability is scale invariant. I use this opportunity to address this widespread confusion about scale invariance. Specifically, I re-introduce the definition of scale invariance and show that branching probability meets this definition.
