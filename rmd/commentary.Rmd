...
knitr::include_graphics(here::here("output/figure_1_example.pdf"))
...
knitr::include_graphics(here::here("output/figure_2_scaling.pdf"))
...
Scale invariance is not unique to rivers [@brownFractalNatureNature2002]. It is observed in predator-prey interactions [@hattonPredatorpreyPowerLaw2015], biological metabolism [@brownMetabolicTheoryEcology2004], food chain length [@saboRoleDischargeVariation2010], and species-area relationships [@hubbellUnifiedNeutralTheory2001], to name just a few. Scaling is a fundamental property of scale-invariant observations, allowing for generalizations across different scales [@levinProblemPatternScale1992; @clarkGeneralStatisticalScaling2021]. However, the meanings of key terms have diverged within the field of ecology. In contrast, the same terms in fractal theory have retained their mathematically defined nature (equation (3) and Table 1) since their initial introduction in the 1960s [@mandelbrotHowLongCoast1967; @rodriguez-iturbeFractalRiverBasins2001; @brownFractalNatureNature2002; @brownMetabolicTheoryEcology2004; @proektScaleInvarianceDynamics2012; @rinaldoEvolutionSelectionRiver2014].
