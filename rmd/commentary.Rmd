...
However, in ecology, the terms are often misused or (implicitly) defined in stark contrast with fractal theory [@rodriguez-iturbeFractalRiverBasins2001; @proektScaleInvarianceDynamics2012]. Ecologists use "scale dependence" when ecological patterns change across scales [@levinProblemPatternScale1992; @clarkGeneralStatisticalScaling2021]. This use of scale dependence *per se* is not an issue; however, a confusion emerges when it is paired with the term "scaling" to characterize scale dependence. Countless numbers of ecological research use "scaling" as a property of "scale dependence" [@chaseEmbracingScaledependenceAchieve2018; @nishizawaLatitudinalGradientPlant2022; @jarzynaTaxonomicFunctionalDiversity2018; @keilSpatialScalingExtinction2018; @gonzalezScalingupBiodiversityecosystemFunctioning2020], although some ecologists refer to scaling as a property of scale invariance as defined in fractal theory [@hubbellUnifiedNeutralTheory2001; @brownFractalNatureNature2002; @brownMetabolicTheoryEcology2004]. This confusion is so widespread that the diverged use of the same terms between ecology and mathematics is unavoidable.
