...
where $\lambda$ is an arbitrary constant and $z$ is the scaling exponent. The above equation is interpreted as the proof of "scale invariance" because the multiplicative extension/shrink of observation scale $x$ by factor $\lambda$ results in the same shape of the original object $y$ but with a *different scale* [@proektScaleInvarianceDynamics2012] (i.e., the structural property is retained).
