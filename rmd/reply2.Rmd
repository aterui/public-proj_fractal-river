...
> Thank you, I agree with reviwer's opinion. Please see my specific responses to the reviewer comments for details. Please also notice that, as part of response to the reviewer, I re-worded the last sentence in the Abstract to avoid any confusion as "This provided an opportunity to address the distinct use of "scale invariance" and "scaling" in the ecological literature."
