...
> I appreciate your attention to detail. Their major finding, albeit incorrect, is "branching probability is scale dependent." This is the conclusion of the article. I revised the manuscript so the readers can understand this point (see "Practical Issues" in the revised MS).

> Along this line, they argued that branching probability does not represent river's branching character because of the lack of characteristic scale (this is what they referred to as "scale dependent," although it is the property of scale invariance...). This argument also arose from their misunderstanding of scale invariance. I added text to clarify this point ("Practical Issues").

> Lastly, I would like to mention that all the analysis in their article is fundamentally flawed to begin with. Their data sources are inappropriate as they used different resolutions of DEMs among watersheds when estimating real river structures, ranging from less than 100 meters to over 1000 meters (this is ~two orders of difference in areal resolution!!!). As a result, I had to reanalyze the data with entirely new sources (Yamazaki et al. 2019) since their original data are unreliable. Therefore, in my opinion, any conclusions drawn in their article are not trustworthy. Nonetheless, I do not want to delve into the specifics since most readers may not be interested in these details (yet, this fundamental issue overturns the entire content of the article). While I wrote "important insights" for courtesy, there is nothing in their article that I can rely on. Please see my preprint for more details: https://www.biorxiv.org/content/10.1101/2022.11.07.515375v2.full 
